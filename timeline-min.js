  ...
  t.TL = {
    ...
    linkify: function(t, e, i) {
      var n = function(t, e, i) {
          i || (i = "");
          var n = 30;
          return e && e.length > n && (e = e.substring(0, n) + "â€¦"), i + "<a class='tl-makelink' href='" + t + "' onclick='void(0)'>" + e + "</a>"
        },
    ...
    slugify: function(t) {
      ...
      for (var e = "Ã£Ã Ã¡Ã¤Ã¢áº½Ã¨Ã©Ã«ÃªÃ¬Ã­Ã¯Ã®ÃµÃ²Ã³Ã¶Ã´Ã¹ÃºÃ¼Ã»Ã±Ã§Â·/_,:;", i = "aaaaaeeeeeiiiiooooouuuunc------", n = 0, a = e.length; n < a; n++) t = t.replace(new RegExp(e.charAt(n), "g"), i.charAt(n));
      ...
      function($) {
        ...
        $.active = 0, $.ajaxJSONP = function(t, e) {
          ...
          if (n && n.promise(T), e.crossDomain || v("X-Requested-With", "XMLHttpRequest"), v("Accept", f || "*/*"), (f = e.mimeType || f) && (f.indexOf(",") > -1 && (f = f.split(",", 2)[0]), T.overrideMimeType && T.overrideMimeType(f)), (e.contentType || e.contentType !== !1 && e.data && "GET" != e.type.toUpperCase()) && v("Content-Type", e.contentType || "application/x-www-form-urlencoded"), e.headers)
            for (p in e.headers) v(p, e.headers[p]);
          ...
          if (e.xhrFields)
            for (p in e.xhrFields) T[p] = e.xhrFields[p];
    ...
    function a(a, d, u, m, _) {
      ...
      if (r || n(), d)
        if (d = "string" == typeof d ? [d] : d.concat(), w || r.async || r.gecko || r.opera) c[a].push({
          ...
          for (p = 0, f = d.length; p < f; ++p) c[a].push({
            urls: [d[p]],
    ...
    createMedia: function() {
      ...
      this._el.content_item = TL.Dom.create("div", "tl-media-item tl-media-image tl-media-imgur", this._el.content), TL.ajax({
        ...
        error: function(e, i, n) {
          if (tc = new TL.TimelineConfig, "parsererror" == i) var n = new TL.Error("invalid_url_err");
          else var n = new TL.Error("unknown_read_err", i);
